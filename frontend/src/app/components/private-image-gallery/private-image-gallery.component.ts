...
@Component({
  selector: 'app-private-image-gallery',
  templateUrl: './private-image-gallery.component.html',
  styleUrl: './private-image-gallery.component.scss'
})
export class PrivateImageGalleryComponent {
  ...
  onUpload() {
    ...
    uploadImageData.append('galleryType', GalleryType.PRIVATE);
  ...
  getImages(): void{
    ...
    params['galleryType'] = GalleryType.PRIVATE;
